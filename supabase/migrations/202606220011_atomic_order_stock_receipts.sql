...
declare
  ...
  receipt_id uuid;
  safe_accepted numeric := greatest(coalesce(p_accepted_quantity, 0), 0);
begin
  ...
  insert into public.order_receipts (
    ...
    greatest(coalesce(p_ordered_quantity, 0), 0), greatest(coalesce(p_received_quantity, 0), 0),
