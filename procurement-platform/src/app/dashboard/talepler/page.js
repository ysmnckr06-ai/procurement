...
function Sidebar() {
  const menu = [
    ...
    { name: "Talepler", icon: "📚", href: "/dashboard/talepler", active: true },
  ...
  return (
    <aside className="hidden min-h-screen w-72 shrink-0 border-r border-slate-200 bg-white p-5 lg:block">
      ...
      <div className="mt-5 rounded-2xl border border-purple-100 bg-purple-50 p-4 text-sm text-purple-900">
        <div className="font-bold">Talep İcmal Modülü</div>
        <p className="mt-1">
          Excel, PDF ve görsellerden ürün kalemlerini çıkarıp icmal listesi oluşturur.
        </p>
      </div>
    </aside>
  );
